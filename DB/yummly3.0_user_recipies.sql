...
--
-- Table structure for table `user_recipies`
--
...
--
-- Dumping data for table `user_recipies`
--

LOCK TABLES `user_recipies` WRITE;
/*!40000 ALTER TABLE `user_recipies` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_recipies` ENABLE KEYS */;
UNLOCK TABLES;
